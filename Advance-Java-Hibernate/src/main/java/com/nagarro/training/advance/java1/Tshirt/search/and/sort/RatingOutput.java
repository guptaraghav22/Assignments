...
{
    public static void getRatingOutput(String[] inputarr) {
        ...
        Query<Product> query = session
                .createQuery("from Product where colour=:c and genderRecommendation=:g and size=:s order by rating", Product.class);
