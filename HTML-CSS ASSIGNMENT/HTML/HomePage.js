...
function Validation()
{
    ...
    var vGenderMale = document.getElementById("Male").checked==true;
    var vGenderFemale = document.getElementById("Female").checked==true;
    var vJava=document.getElementById("Java").checked==true;
    var vHtml = document.getElementById("Html").checked==true;
    var vCss = document.getElementById("Css").checked==true;
    ...
    if((vGenderFemale==false)&&(vGenderMale==false))
    {
        document.getElementById("usergender").innerHTML="Enter Gender";
        
        return false;
        
    }
    if((vJava==false)&&(vHtml==false)&&(vCss==false))
    {
        document.getElementById("userskills").innerHTML="Enter Skills";
    }
